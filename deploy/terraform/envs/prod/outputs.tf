...
output "alarm_topic_arn" {
  description = "SNS topic s alarmy. Odběr e-mailem je potřeba potvrdit klikem v došlé zprávě."
...
output "backup_freshness_function" {
  description = "Kontrola stáří zálohy — pro ruční spuštění při ověřování."
  value       = module.backup_freshness.function_name
}
